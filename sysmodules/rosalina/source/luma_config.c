...
// bool isRelease = (bool)outInfo;
    ...
    if (GET_VERSION_REVISION(version) != 0) {
        sprintf(lumaVerStr, "RadiantLuma v1.1 (Luma v%d.%d.%d)", (int)GET_VERSION_MAJOR(version), (int)GET_VERSION_MINOR(version), (int)GET_VERSION_REVISION(version));
    } else {
        sprintf(lumaVerStr, "RadiantLuma v1.1 (Luma v%d.%d)",  (int)GET_VERSION_MAJOR(version), (int)GET_VERSION_MINOR(version));
    }
